...
const Header = () => {
  ...
  useEffect(() => {
    ...
    const minicart = searchParams.get('minicart');
    if (Boolean(minicart)) setMinicartActive(true);

    searchParams.delete('minicart');
  ...
  useEffect(() => {
    ...
    if (mobileHeaderActive || minicartActive || mobileSearchActive) {
  ...
  }, [mobileHeaderActive, minicartActive, mobileSearchActive]);

  useEffect(() => {
    if (!minicartActive) return;
          ...
          <nav class="offcanvas__menu">
            <ul class="offcanvas__menu_ul">
              <li class="offcanvas__menu_li">
                <Link class="offcanvas__menu_item" to="/catalog">
                  Catalog
                </Link>
              </li>
              <li class="offcanvas__menu_li">
                <Link class="offcanvas__menu_item" to="/fundraising">
                  Fundraising
                </Link>
                <button
              ...
              <li class="offcanvas__menu_li">
                ...
                <ul class="offcanvas__sub_menu">
                  <li class="offcanvas__sub_menu_li">
                    <Link to="/start" class="offcanvas__sub_menu_item">
                      Become a Seller
                    </Link>
                  </li>
                  {/* <li class="offcanvas__sub_menu_li">
              ...
              <li class="offcanvas__menu_li">
                <Link class="offcanvas__menu_item" to="/campaigns">
                  Campaigns
                </Link>
              </li>
              <li class="offcanvas__menu_li">
  ...
  return (
    <>
      ...
      <header class="header__section">
        <div
          class={
            'main__header header__sticky ' + (headerSticky ? 'sticky' : '')
          }
          style={{ zIndex: 199 }}
        >
          <div class="container-fluid">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
              ...
              <div class="header__search--widget header__sticky--none d-none d-lg-block">
                <form
                  class="d-flex header__search--form"
                ...
                <nav class="header__menu--navigation">
                  <ul class="d-flex">
                    <li class="header__menu--items style2 d-none d-xl-block">
                      <Link class="header__menu--link" to="/catalog">
                        Catalog
                      </Link>
                    </li>
                    <li class="header__menu--items style2 d-none d-xl-block">
                      <Link class="header__menu--link" to="/fundraising">
                        Fundraising
                        <svg
                    ...
                    <li class="header__menu--items style2">
                      ...
                      <ul class="header__sub--menu">
                        <li class="header__sub--menu__items">
                          <Link to="/start" class="header__sub--menu__link">
                            Become a Seller
                          </Link>
                        </li>
                        {/* <li class="header__sub--menu__items">
                    ...
                    <li class="header__menu--items style2">
                      <Link class="header__menu--link" to="/campaigns">
                        Campaigns
                      </Link>
                    </li>
                    <li class="header__menu--items style2">
          ...
          <ul class="d-flex justify-content-between">
            ...
            <li class="offcanvas__stikcy--toolbar__list">
              <Link class="offcanvas__stikcy--toolbar__btn" to="/wishlist">
                ...
                {getWishlistQuantity() ? (
                  <span class="items__count">{getWishlistQuantity()}</span>
                ) : (
                  ''
                )}
              </Link>
        ...
        <div
          class={
            'predictive__search--box ' + (mobileSearchActive ? 'active' : '')
          }
        >
