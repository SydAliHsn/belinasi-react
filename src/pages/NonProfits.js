      ...
      <section class="section--padding banner-shirt">
        <div class="container banner-shirt__container">
          <div class="banner-shirt__content">
            <h2 class="h2">NonProfit fundraising made simpler</h2>
            <p class="text-main">
        ...
        <div class="container ready-section__container">
          <div class="ready-section__content">
            <h2 class="h2 h-slim text-half-width">
              Ready to launch your NonProfit fundraiser?
            </h2>
            <p class="text-main">
              In just a few minutes, your NonProfit fundraiser can be launched
