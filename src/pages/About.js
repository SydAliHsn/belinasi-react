  ...
  return (
    <React.Fragment>
      ...
      <main class="main__content_wrapper">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="about__thumb d-flex">
                  <img src="/assets/img/banner/about-banner.jpg" />
                  {/* <div class="about__thumb--items">
                  <img
                    class="about__thumb--img border-radius-5 display-block"
              ...
              <div class="col-lg-6">
                <div class="about__content">
                  ...
                  <h2 class="about__content--maintitle mb-25">
                    Donate to us or I will kick your grandma
                  </h2>
                  ...
                  <p class="about__content--desc mb-25">
                    ...
                    suscipit est corrupti explicabo non perspiciatis, excepturi
                    ut asperiores assumenda rerum? Provident ab corrupti sequi,
                    voluptates repudiandae eius odit aut.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div
          class="counterup__banner--section counterup__banner__bg2"
          id="funfactId"
        >
          <div class="container">
              ...
              <div class="col">
                <div class="counterup__banner--inner position__relative d-flex align-items-center justify-content-between">
                  <div class="counterup__banner--items text-center">
                    ...
                    <span
                      class="counterup__banner--items__number js-counter text-white"
                      data-count="50"
                    >
                      69
                    </span>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                  <div class="team__items text-center">
                    <div class="team__thumb">
                      <img
                        class="team__thumb--img border-radius-50"
